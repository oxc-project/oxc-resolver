// napi-rs-artifact-metadata:{"version":2,"rootEntry":"index.js","exports":["ResolverFactory","EnforceExtension","ModuleType","sync"],"managedRootEntries":["browser.js","index.js","resolver.wasm","resolver.debug.wasm"]}
/* eslint-disable */
/* prettier-ignore */
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  const __wasiPackageEntry = require.resolve('@oxc-resolver/binding-wasm32-wasi')
  ...
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      '@oxc-resolver/binding-wasm32-wasi is installed but is missing resolver.wasm32-wasi.wasm.',
    )
  }
