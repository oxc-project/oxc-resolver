...
test('resolve pnpm package', () => {
  ...
  assert.deepEqual(
    ...
    join(
      rootDir,
      'node_modules/.pnpm/styled-components@6.1.1_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/styled-components/dist/styled-components.browser.cjs.js',
    ),
  );
  ...
  const react = resolver.sync(
    join(
      rootDir,
      'node_modules/.pnpm/styled-components@6.1.1_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/styled-components',
    ),
    'react',
  );
  assert.deepEqual(
