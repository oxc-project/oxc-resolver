...
const enhancedResolveRoot = join(fixturesDir, "enhanced-resolve", "test", "fixtures");
...
for (const [title, context, request, expected] of [
  ...
  ["file with .js", enhancedResolveRoot, "./main1.js", join(enhancedResolveRoot, "main1.js")],
  ["file without extension", enhancedResolveRoot, "./main1", join(enhancedResolveRoot, "main1.js")],
  ["another file with .js", enhancedResolveRoot, "./a.js", join(enhancedResolveRoot, "a.js")],
  ["another file without extension", enhancedResolveRoot, "./a", join(enhancedResolveRoot, "a.js")],
  [
